...
function Sidebar({ collapsed, setCollapsed }) {
  ...
  const menuItems = [
    ...
    { name: 'Quản lí nhân viên', icon: <Users size={18} />, path: '/admin/employees', badge: null },
    { name: 'Quản lí sản phẩm', icon: <Package size={18} />, path: '/admin/products', badge: '25' },
    { name: 'Quản lí danh mục', icon: <List size={18} />, path: '/admin/catalogs', badge: null },
    { name: 'Quản lí thể loại', icon: <Grid size={18} />, path: '/admin/categories', badge: null },
